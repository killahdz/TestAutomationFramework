...
namespace Security.Features.Resolver
{
    ...
    [NUnit.Framework.DescriptionAttribute("Security.Features.Resolver.Login")]
    public partial class Security_Features_Resolver_LoginFeature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Security.Features.Resolver.Login", "\tIn order to access the rttms system\r\n\tI need to be able to log in", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [NUnit.Framework.DescriptionAttribute("LoginTestUser")]
        [NUnit.Framework.CategoryAttribute("dev")]
        [NUnit.Framework.CategoryAttribute("prod")]
        [NUnit.Framework.CategoryAttribute("video")]
        public virtual void LoginTestUser()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("LoginTestUser", new string[] {
                        "dev",
                        "prod",
                        "video"});
#line 6
